...
static SemaphoreHandle_t xBinSemaphore;
...
xTask task1 = { TASK1_WCET, TASK1_PERIOD, pdTRUE };
xTask task2 = { TASK2_WCET, TASK2_PERIOD, pdFALSE };
xTask task3 = { TASK3_WCET, TASK3_PERIOD, pdTRUE };
...
int main( void )
{
    ...
    {
        prvPrintString("Error creando mutex!\r\n");
        for (;;);
    }
