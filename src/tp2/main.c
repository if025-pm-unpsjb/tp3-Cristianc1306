...
/* Estructura para definir cada sistema */
typedef struct {
    uint8_t numTasks;
    xTaskStruct tareas[5]; 
} SistemaConfig;

/* Tabla con todos los sistemas */
static const SistemaConfig sistemas[] = {
    // SISTEMA 1
    {3, { {1000,4000}, {1000,5000}, {2000,8000} }},

    // SISTEMA 2
    {3, { {1000,4000}, {1000,8000}, {2000,9000} }},

    // SISTEMA 3
    {4, { {1000,4000}, {1000,6000}, {1000,8000}, {3000,13000} }},

    // SISTEMA 4
    {4, { {1000,4000}, {2000,7000}, {1000,12000}, {2000,14000} }},

    // SISTEMA 5
    {5, { {1000,5000}, {1000,9000}, {1000,10000}, {2000,15000}, {2000,16000} }},

    // SISTEMA 6
    {5, { {1000,6000}, {1000,8000}, {2000,11000}, {1000,15000}, {2000,17000} }},

    // SISTEMA 7
    {4, { {1000,4000}, {1000,7000}, {2000,10000}, {2000,14000} }},

    // SISTEMA 8
    {4, { {1000,4000}, {1000,8000}, {2000,10000}, {2000,14000} }},

    // SISTEMA 9
    {5, { {1000,5000}, {1000,8000}, {2000,12000}, {1000,15000}, {1000,16000} }},

    // SISTEMA 10
    {5, { {1000,5000}, {1000,8000}, {1000,12000}, {1000,13000}, {2000,16000} }}
};

xTaskStruct tasks[5];
uint8_t numTasks;

/* Configuración según sistema elegido */
#define SISTEMA 10

void configurarSistema(void)
{
    const SistemaConfig *cfg = &sistemas[SISTEMA - 1];
    numTasks = cfg->numTasks;

    for (uint8_t i = 0; i < numTasks; i++) {
        tasks[i] = cfg->tareas[i];
    }
}
